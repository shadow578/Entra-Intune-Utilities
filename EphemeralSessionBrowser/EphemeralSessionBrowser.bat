...
"@
  ...
  Set-ItemProperty -Path $uninstallKey -Name "Publisher" -Value $ProgramInfo.VendorDisplayName
...
"@
  ...
  $aboutTextContent = @"
$($ProgramInfo.DisplayName) ($($ProgramInfo.Version)), by $($ProgramInfo.VendorDisplayName).
